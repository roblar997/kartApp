...
public class SeverdighetListeActivity extends AppCompatActivity implements
        GoogleApiClient.ConnectionCallbacks,
        GoogleApiClient.OnConnectionFailedListener, MyDialog.DialogClickListener, LocationListener, OnMapReadyCallback {

    public static final String TAG = SeverdighetListeActivity.class.getSimpleName();
        ...
        for (String adresse : addresser) {
            ...
            velg.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent lagreIntent = new Intent(SeverdighetListeActivity.this, LagreActivity.class);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                Intent mainIntent2= new Intent(SeverdighetListeActivity.this, MapsActivity.class);
